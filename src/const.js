...
export const TOKEN_DIR = `${process.env.HOME ||
  process.env.HOMEPATH ||
  process.env.USERPROFILE}/.credentials/`;
export const GAPI_TOKEN_PATH = `${TOKEN_DIR}googleapis-branch-cleanup-${packageJson.version}.json`;
export const API_TOKEN_PATH = `${TOKEN_DIR}branch-cleanup-${packageJson.version}.json`;
export const PROCESS_SHEET_COMMAND = 'process-sheet';
export const DEFAULT_CLIENT_SECRET_PATHS = [
  './google_client_secret.json',
  `${TOKEN_DIR}google_client_secret.json`,
];
